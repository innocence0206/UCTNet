...
def restore_model(pkl_file, checkpoint=None, train=False, fp16=None):
    ...
    init = info['init']
    # init = list(init)
    # init[2] = '/home/gxy/code/UCTNet-main/UCTNet/nnUNet_trained_models/nnUNet/2d/Task100_ISIC2018/UCTNetTrainer__nnUNetPlansv2.1'
    # init[2] = '/home/gxy/code/UCTNet-main/UCTNet/nnUNet_trained_models/nnUNet/2d/Task027_ACDC/UCTNetTrainer__nnUNetPlansv2.1'
    # init[2] = '/home/gxy/code/UCTNet-main/UCTNet/nnUNet_trained_models/nnUNet/3d_fullres/Task017_AbdominalOrganSegmentation/UCTNetTrainer__nnUNetPlansv2.1'
    # init[9] = 'UCTNet'
    # init[11] = 'UCTNet_3D'
    ...
    # init = tuple(init)
    # info['name'] = 'UCTNetTrainer'
    name = info['name']
    # info['class'] = "<class 'uctnet.training.UCTNetTrainer.UCTNetTrainer'>"
    # info['init'] = init
    # classnnn = info['class']
    # save_pickle(info, pkl_file)
    # print(init)
    # print(classnnn)
    # print('name',name)
    search_in = join(uctnet.__path__[0], "training")
    tr = recursive_find_python_class([search_in], name, current_module="uctnet.training")
